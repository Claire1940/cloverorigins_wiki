...
const SITE_DESCRIPTION =
  "Clover Origins Wiki tracks active codes, grimoire guides, leveling routes, stat resets, race rerolls, broom upgrades, quest flow, and PvP prep for the Roblox Black Clover RPG.";
...
export async function generateMetadata({
  ...
  return {
    title: "Clover Origins Wiki - Codes, Grimoires, Stats & Quests",
    ...
    openGraph: {
      ...
      url: pageUrl,
      siteName: SITE_NAME,
      title: "Clover Origins Wiki - Codes, Grimoires, Stats & Builds",
      description: SITE_DESCRIPTION,
      images: [
        {
          url: heroImageUrl,
