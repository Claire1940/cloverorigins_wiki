...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Clover Origins Wiki',
    description: 'Copyright and intellectual property information for Clover Origins Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Clover Origins Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Clover Origins Wiki',
      description: 'Copyright and intellectual property information for Clover Origins Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Clover Origins Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Clover Origins Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Clover Origins Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Clover Origins Developers</strong> - Creators of the Clover Origins game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Clover Origins</strong> - Trademark of the game developers</li>
              <li><strong>Clover Origins Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Clover Origins Wiki.
            </p>
            ...
            <p>
              ...
              Clover Origins Wiki<br />
              Email: <a href="mailto:dmca@cloverorigins.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cloverorigins.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Clover Origins Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Clover Origins Wiki (cloverorigins.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@cloverorigins.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@cloverorigins.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@cloverorigins.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cloverorigins.wiki</a>
            </p>
            <p>
